...
public class DayOfWeekBasedAccessInterceptor extends HandlerInterceptorAdapter
{
			...
			Object handler, ModelAndView modelAndView) throws Exception
	{
		...
		System.out.println("HandlerInterceptorAdapter : SpringMVC called postHandle method for " + request.getRequestURI().toString());
			...
			Object handler, Exception ex) throws Exception
	{
		...
		System.out.println("HandlerInterceptorAdapter : SpringMVC called afterCompletion method for " + request.getRequestURI().toString());
	}
}
